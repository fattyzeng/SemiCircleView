...
public class SemiCircleMenuItem {
	 ...
	 * @param mText
	 */
	public SemiCircleMenuItem(String id, Drawable mIcon, String mText) {
		super();
		this.mMenuID = id;
		this.mIcon = mIcon;
		this.mText = mText;
	...
	public void setMenuPath(RectF menuButtonRect, RectF menuRect,
		...
		Point drawableCenter = pointOnCircle((radius - (radius / 5)), StartArc
				+ (ArcWidth / 2), anchorPoint);
	...
	/**
	 * @param mMenuNormalColor
	 *            the mMenuNormalColor to set
	 */
	...
	/**
	 * @param mMenuSelectedColor
	 *            the mMenuSelectedColor to set
	 */
